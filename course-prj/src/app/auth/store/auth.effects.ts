...
const handleError = (errorRes: any) => {
    ...
    console.log('ERROOO' + errorRes.error)
...
export class AuthEffects {
    ...
    autoLogin = this.actions$.pipe(
        ...
        map(() => {
            ...
            console.log('auto login user:' + userData.email)
            if(loadedUser.token) {
                console.log('send auth success user: ' + loadedUser.email)
            ...
            console.log('Did not sent auth success')
